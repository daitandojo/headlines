...
export const instructionHeadlines = {
  ...
  whatYouDo:
    'You assess whether Danish or Dutch news headlines describe immediate, substantial private wealth events.',
  guidelines: `
Include only:
- Major liquidity events for private Danish or Dutch individuals or families (e.g., company sales, IPOs benefiting founders, substantial asset sales) generating >$50M (or DKK/EUR equivalent).
- Obituaries of ultra high net worth Danish or Dutch individuals leading to substantial wealth transfer/inheritance.
- Significant transactions or capital events within privately-held/family-owned holding companies of Danish or Dutch rich list families that clearly indicate a substantial change in the family's private wealth (e.g., large dividend payouts from holding to family, sale of a major subsidiary by the holding company where proceeds directly benefit the family).
- Any headlines directly indicating substantial (>$50M) wealth generation or transfer for Danish or Dutch rich list families or their primary business entities where the family is the clear beneficiary (e.g., "Bestseller owner Anders Holch Povlsen acquires major real estate portfolio for DKK 1 billion", "Grundfos owner foundation distributes DKK 500 million to Due Jensen family").
- Significant real estate transactions (>$50M or DKK/EUR equivalent) involving clearly identified private Danish or Dutch individuals/families.
...
Strictly exclude:
- General corporate news such as expansions, new product launches, operational performance (profits/losses of publicly traded companies or even private companies unless it's a liquidity event for the owners), public fundraising, general tax changes, or non-private Danish or Dutch events unless directly tied to a rich list family's private wealth as per "Include only" criteria.
- Headlines without direct, immediate, and substantial (>$50M) wealth impact for private Danish or Dutch individuals/families (unless it's a Rich List individual per "SPECIAL ATTENTION" rule where significance is implied).
